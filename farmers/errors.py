...
def forbidden(e):
    ...
    return render_template('farmers/403.html'), 403


@farmers.app_errorhandler(404)
def page_not_found(e):
    ...
    return render_template('farmers/404.html'), 404


@farmers.app_errorhandler(500)
def internal_server_error(e):
    ...
    return render_template('farmers/500.html'), 500
