...
def forbidden(e):
    ...
    return render_template('drivers/403.html'), 403


@drivers.app_errorhandler(404)
def page_not_found(e):
    ...
    return render_template('drivers/404.html'), 404


@drivers.app_errorhandler(500)
def internal_server_error(e):
    ...
    return render_template('drivers/500.html'), 500
