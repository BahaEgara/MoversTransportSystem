...
def forbidden(e):
    ...
    return render_template('loaders/403.html'), 403


@loaders.app_errorhandler(404)
def page_not_found(e):
    ...
    return render_template('loaders/404.html'), 404


@loaders.app_errorhandler(500)
def internal_server_error(e):
    ...
    return render_template('loaders/500.html'), 500
